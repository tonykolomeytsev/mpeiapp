...
/**
 * FragmentNavigator that keeps fragment view state
 */
public abstract class CachedFragmentNavigator implements Navigator {
    private FragmentManager fragmentManager;
    private int containerId;
    protected LinkedList<String> localStackCopy;
    protected HashMap<Fragment, Boolean> addedFragmentsCache;
     ...
     */
    public CachedFragmentNavigator(FragmentManager fragmentManager, int containerId) {
