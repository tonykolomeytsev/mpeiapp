...
public open class ShimmerItem(@LayoutRes public val id: Int)

public open class ShimmerAdapterItem(@LayoutRes layoutId: Int) : AdapterItem<ShimmerViewHolder, ShimmerItem>(
