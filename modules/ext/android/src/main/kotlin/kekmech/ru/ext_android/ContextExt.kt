...
public fun Context.getResDrawable(@DrawableRes res: Int): Drawable = checkNotNull(ContextCompat.getDrawable(this, res))

@ColorInt
public fun Context.getResColor(@ColorRes res: Int): Int = checkNotNull(ContextCompat.getColor(this, res))

@Px
public fun Context.getIntDimen(@DimenRes res: Int): Int = resources.getDimensionPixelSize(res)
