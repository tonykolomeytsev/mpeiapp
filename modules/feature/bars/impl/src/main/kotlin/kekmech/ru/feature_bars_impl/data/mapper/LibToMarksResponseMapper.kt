...
import com.kekmech.lib_bars.user.ControlActivityType.CONTROL_ACTIVITY
import com.kekmech.lib_bars.user.ControlActivityType.UNDEFINED
...
internal object LibToMarksResponseMapper {

    fun map(rawMarksResponse: List<Discipline>) = MarksResponse(
        payload = rawMarksResponse.map { disciplineRow ->
            AssessedDiscipline(
