...
public fun RecyclerView.addScrollAnalytics(analytics: Analytics, elementName: String) {
...
public fun ViewPager2.addScrollAnalytics(analytics: Analytics, elementName: String) {
