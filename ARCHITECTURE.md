...
Обращайте внимание на заметки **Архитектурный инвариант**. В них написано об 
ограничениях, намеренно наложенных на исходный код, которые позволяют держать сложность проекта в узде.
...
Подробнее про композитные билды:
